...
const Hero = () => {
    ...
    return (
        <section id="home" ref={parallaxRef} className="min-h-screen flex items-center pt-16 pb-20 lg:pt-20 lg:pb-28 overflow-hidden">
            <ScrollSection>
                        ...
                        <div className="lg:col-span-5">
                            ...
                            <div className="animate flex flex-wrap gap-4 pt-4">
                                <div className="relative group">
                                    ...
                                    <div className="absolute top-full left-0 mt-2 w-56 bg-white border border-slate-100 rounded-xl shadow-xl py-2 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                        <a
